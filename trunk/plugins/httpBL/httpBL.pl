...
#
    ...
    settings               => new MT::PluginSettings([
        ['httpbl_age',           { Default => 255, Scope => 'blog' }],
        ['httpbl_age_mode',      { Default => 2,   Scope => 'blog' }],
        ['httpbl_age_weight',    { Default => 1,   Scope => 'blog' }],
        ['httpbl_threat',        { Default => 1,   Scope => 'blog' }],
        ['httpbl_threat_mode',   { Default => 2,   Scope => 'blog' }],
        ['httpbl_threat_weight', { Default => 1,   Scope => 'blog' }],
        ['httpbl_type_1',        { Default => 1,   Scope => 'blog' }],
        ['httpbl_type_2',        { Default => 1,   Scope => 'blog' }],
        ['httpbl_type_3',        { Default => 1,   Scope => 'blog' }],
        ['httpbl_type_mode',     { Default => 2,   Scope => 'blog' }],
        ['httpbl_type_weight',   { Default => 1,   Scope => 'blog' }],
